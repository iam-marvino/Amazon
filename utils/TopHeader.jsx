...
import { addUser } from "@/app/Redux/appSlices";
      ...
      >
        ...
        >
          <Image
            src={logo}
            alt="logo"
            style={{ width: "7rem", objectFit: "cover", marginTop: "4px" }}
          />
        </div>
        {/* location */}
        <div
        ...
        {/* Search Bar */}
        <div
          className="flex-1 h-10 lg:inline-flex items-center 
        ...
        >
          <input
            ...
            className=" hidden lg:block w-full  h-full rounded-md pl-2 placeholder:text-sm 
            text-base text-black border-[3px] border-transparent 
            outline-none focus-visible:border-amazon_yellow"
          />
          <span
            className="hidden lg:flex bg-amazon_yellow w-12 h-full text-black text-2xl
             justify-center items-center absolute right-0 rounded-br-md 
            rounded-tr-md"
          >
            <HiOutlineSearch />
          </span>
        ...
        >
          ...
          />
          <p className=" text-xs text-white hidden md:block font-bold mt-3">
            Cart
          </p>
          <span
            className=" text-amazon_yellow absolute text-sm font-semibold 
              top-[0.02rem] left-[30px] 
            "
          >
            {cart?.length}
          </span>
